...
import com.example.graphql.resolvers.expense.*
import com.example.graphql.resolvers.party.*
    ...
    fun dataLoaderRegistryFactory(): DataLoaderRegistryFactory {
        return object : DataLoaderRegistryFactory {
            override fun generate(): DataLoaderRegistry {
                ...
                registry.register(PARTY_MESSAGES_LOADER_NAME, partyDataLoaderBuilder.getMessagesDataLoader())
                ...
                registry.register(EXPENSE_MESSAGES_LOADER_NAME, expenseDataLoaderBuilder.getMessagesDataLoader())
                ...
                registry.register(PAYMENT_MESSAGES_LOADER_NAME, paymentDataLoadersBuilder.getMessagesDataLoader())
                ...
                registry.register(BULK_PAYMENT_MESSAGES_LOADER_NAME, bulkPaymentDataLoadersBuilder.getMessagesDataLoader())
